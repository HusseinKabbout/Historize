...
class Ui_Historize(object):
    def setupUi(self, Historize):
        ...
        Historize.resize(591, 409)
        self.buttonBox = QtGui.QDialogButtonBox(Historize)
        self.buttonBox.setGeometry(QtCore.QRect(240, 370, 341, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.tabDoc = QtGui.QTabWidget(Historize)
        self.tabDoc.setGeometry(QtCore.QRect(0, 10, 591, 351))
        ...
        self.boxHistoLyr.setGeometry(QtCore.QRect(0, 160, 581, 151))
        ...
        self.boxNonHistoLyr.setGeometry(QtCore.QRect(0, 3, 581, 151))
        ...
        self.btnTestConn.setGeometry(QtCore.QRect(450, 270, 121, 34))
        self.btnTestConn.setObjectName(_fromUtf8("btnTestConn"))
        self.layoutWidget = QtGui.QWidget(self.dbTab)
        self.layoutWidget.setGeometry(QtCore.QRect(2, 3, 571, 261))
        self.layoutWidget.setObjectName(_fromUtf8("layoutWidget"))
        self.gridLayout = QtGui.QGridLayout(self.layoutWidget)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.dbLabel = QtGui.QLabel(self.layoutWidget)
        self.dbLabel.setObjectName(_fromUtf8("dbLabel"))
        self.gridLayout.addWidget(self.dbLabel, 0, 0, 1, 2)
        self.lneDatabase = QtGui.QLineEdit(self.layoutWidget)
        self.lneDatabase.setObjectName(_fromUtf8("lneDatabase"))
        self.gridLayout.addWidget(self.lneDatabase, 0, 3, 1, 1)
        self.hostLabel = QtGui.QLabel(self.layoutWidget)
        ...
        self.lneHost = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.lnePort = QtGui.QLineEdit(self.layoutWidget)
        self.lnePort.setObjectName(_fromUtf8("lnePort"))
        self.gridLayout.addWidget(self.lnePort, 2, 3, 1, 1)
        self.userLabel = QtGui.QLabel(self.layoutWidget)
        ...
        self.textBrowser.setGeometry(QtCore.QRect(0, 10, 581, 301))
        self.textBrowser.setObjectName(_fromUtf8("textBrowser"))
        self.tabDoc.addTab(self.tabDoc1, _fromUtf8(""))
        self.layoutWidget1 = QtGui.QWidget(Historize)
        ...
        self.layoutWidget2 = QtGui.QWidget(Historize)
